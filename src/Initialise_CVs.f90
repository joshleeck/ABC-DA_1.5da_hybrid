...
IF (.NOT.ALLOCATED(state % v1)) ALLOCATE (state % v1 (0:nlongs+1,0:nlevs+1))
IF (.NOT.ALLOCATED(state % v2)) ALLOCATE (state % v2 (0:nlongs+1,0:nlevs+1))
IF (.NOT.ALLOCATED(state % v3)) ALLOCATE (state % v3 (0:nlongs+1,0:nlevs+1))
IF (.NOT.ALLOCATED(state % v4)) ALLOCATE (state % v4 (0:nlongs+1,0:nlevs+1))
IF (.NOT.ALLOCATED(state % v5)) ALLOCATE (state % v5 (0:nlongs+1,0:nlevs+1))
IF (.NOT.ALLOCATED(state % v6)) ALLOCATE (state % v6 (0:nlongs+1,0:nlevs+1))
