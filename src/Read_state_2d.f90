SUBROUTINE Read_state_2d (filename, state, dims, t_input, core_only)
...
INTEGER                   :: z, ntimes, t
REAL(ZREAL8), ALLOCATABLE :: temp(:), tempvert(:)

!PRINT*,'read field called'

ALLOCATE (temp(1:nlongs))
ALLOCATE (tempvert(1:nlevs))
