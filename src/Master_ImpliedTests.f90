...
CALL Deallocate_model_vars (LS, .FALSE.)
CALL Deallocate_CVs (CV1, .FALSE.)
CALL Deallocate_CVs (CV2, .FALSE.)
CALL Deallocate_CVs (CVinterim, .FALSE.)
CALL Deallocate_CVs (CVinterim1, .FALSE.)
CALL Deallocate_CVs (CVinterim2, .FALSE.)
