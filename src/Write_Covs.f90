...
REAL(ZREAL8), ALLOCATABLE     :: wavenumbers(:)
REAL(ZREAL8), ALLOCATABLE     :: vert_mode(:)
INTEGER                       :: scalar(1:1)
INTEGER                       :: x, l, k
...
!*****************************************************************************************
  ...
  ALLOCATE (wavenumbers(1:nlongs/2+1))
  ALLOCATE (vert_mode(1:nlevs))
  ...
  DEALLOCATE (wavenumbers, vert_mode)
