...
data_dir = [
data_dir.append('/scratch/leeck/ABC-DA_1.5da_leeck/test/da_cycle_0002')
...
for datadir in data_dir:
  ...
  con_levs = [-2.75,-2.25,-1.75,-1.25,-0.75,-0.25,0.25,0.75,1.25,1.75,2.25,2.75]
...
#  cmap    = cm.get_cmap('Greys', 11)
  ...
  # Labels etc
  ax.set_title('Zonal wind (u)' + '\nmin=' + str.format('%.2f' % minfield) + ', max=' + str.format('%.2f' % maxfield) + ', mean=' + str.format('%.5f' % mn), fontsize=16)
