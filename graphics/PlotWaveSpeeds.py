...
#
# As the code stands, the wave frequencies are read-in from a number of
# experiments (5 experiments) and plotted together on the same plot.
# This allows comparison of the wave characteristics of different model
# parameters (corresponding to the different experiments).
#
# The code can be edited to plot wave characteristics from a single
# experiment only.
#
...
# Data directory
data_dir = 'home/Master_Linear_Analysis'
...
grav_freq01 = read_freq (nz, nlongs, data_dir + '/Run01/grav_frequency.dat')
grav_freq02 = read_freq (nz, nlongs, data_dir + '/Run02/grav_frequency.dat')
grav_freq03 = read_freq (nz, nlongs, data_dir + '/Run03/grav_frequency.dat')
grav_freq04 = read_freq (nz, nlongs, data_dir + '/Run04/grav_frequency.dat')
grav_freq05 = read_freq (nz, nlongs, data_dir + '/Run05/grav_frequency.dat')

print ('Reading in acoustic wave frequencies')
acou_freq01 = read_freq (nz, nlongs, data_dir + '/Run01/acou_frequency.dat')
acou_freq02 = read_freq (nz, nlongs, data_dir + '/Run02/acou_frequency.dat')
acou_freq03 = read_freq (nz, nlongs, data_dir + '/Run03/acou_frequency.dat')
acou_freq04 = read_freq (nz, nlongs, data_dir + '/Run04/acou_frequency.dat')
acou_freq05 = read_freq (nz, nlongs, data_dir + '/Run05/acou_frequency.dat')
